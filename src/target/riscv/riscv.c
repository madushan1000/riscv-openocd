	...
	for (uint32_t number = 0; number < target->reg_cache->num_regs; number++) {
		...
		if (number <= GDB_REGNO_XPR31) {
			...
			switch (csr_number) {
				...
				case THEAD_C9XX_CSR_MHCR:
				case THEAD_C9XX_CSR_MCOR:
				case THEAD_C9XX_CSR_MCCR2:
				case THEAD_C9XX_CSR_MCER2:
				case THEAD_C9XX_CSR_MHINT:
				case THEAD_C9XX_CSR_MRMR:
				case THEAD_C9XX_CSR_MRVBR:
				case THEAD_C9XX_CSR_MCER:
				case THEAD_C9XX_CSR_MCOUNTERWEN:
				case THEAD_C9XX_CSR_MCOUNTERINTEN:
				case THEAD_C9XX_CSR_MCOUNTEROF:
				case THEAD_C9XX_CSR_MHINT2:
				case THEAD_C9XX_CSR_MHINT3:
				case THEAD_C9XX_CSR_MRADDR:
				case THEAD_C9XX_CSR_MEXSTATUS:
				case THEAD_C9XX_CSR_MNMICAUSE:
				case THEAD_C9XX_CSR_MNMIPC:
				case THEAD_C9XX_CSR_MHPMCR:
				case THEAD_C9XX_CSR_MHPMSR:
				case THEAD_C9XX_CSR_MHPMER:
				case THEAD_C9XX_CSR_MSMPR:
				case THEAD_C9XX_CSR_MTEECFG:
				case THEAD_C9XX_CSR_MZONEID:
				case THEAD_C9XX_CSR_ML2CPID:
				case THEAD_C9XX_CSR_ML2WP:
				case THEAD_C9XX_CSR_MDTCMCR:
				case THEAD_C9XX_CSR_USP:
				case THEAD_C9XX_CSR_MCINS:
				case THEAD_C9XX_CSR_MCINDEX:
				case THEAD_C9XX_CSR_MCDATA0:
				case THEAD_C9XX_CSR_MCDATA1:
				case THEAD_C9XX_CSR_MEICR:
				case THEAD_C9XX_CSR_MEICR2:
				case THEAD_C9XX_CSR_MBEADDR:
				case THEAD_C9XX_CSR_MCPUID:
				case THEAD_C9XX_CSR_MAPBADDR:
				case THEAD_C9XX_CSR_MWMSR:
				case THEAD_C9XX_CSR_MHALTCAUSE:
				case THEAD_C9XX_CSR_MDBGINFO:
				case THEAD_C9XX_CSR_MPCFIFO:
				case THEAD_C9XX_CSR_SXSTATUS:
				case THEAD_C9XX_CSR_SHCR:
				case THEAD_C9XX_CSR_SCER2:
				case THEAD_C9XX_CSR_SCER:
				case THEAD_C9XX_CSR_SCOUNTERINTEN:
				case THEAD_C9XX_CSR_SCOUNTEROF:
				case THEAD_C9XX_CSR_SHINT:
				case THEAD_C9XX_CSR_SHINT2:
				case THEAD_C9XX_CSR_SHPMINHIBIT:
				case THEAD_C9XX_CSR_SHPMCR:
				case THEAD_C9XX_CSR_SHPMSR:
				case THEAD_C9XX_CSR_SHPMER:
				case THEAD_C9XX_CSR_SL2CPID:
				case THEAD_C9XX_CSR_SL2WP:
				case THEAD_C9XX_CSR_SBEADDR:
				case THEAD_C9XX_CSR_SCYCLE:
				case THEAD_C9XX_CSR_SHPMCOUNTER1:
				case THEAD_C9XX_CSR_SHPMCOUNTER2:
				case THEAD_C9XX_CSR_SHPMCOUNTER3:
				case THEAD_C9XX_CSR_SHPMCOUNTER4:
				case THEAD_C9XX_CSR_SHPMCOUNTER5:
				case THEAD_C9XX_CSR_SHPMCOUNTER6:
				case THEAD_C9XX_CSR_SHPMCOUNTER7:
				case THEAD_C9XX_CSR_SHPMCOUNTER8:
				case THEAD_C9XX_CSR_SHPMCOUNTER9:
				case THEAD_C9XX_CSR_SHPMCOUNTER10:
				case THEAD_C9XX_CSR_SHPMCOUNTER11:
				case THEAD_C9XX_CSR_SHPMCOUNTER12:
				case THEAD_C9XX_CSR_SHPMCOUNTER13:
				case THEAD_C9XX_CSR_SHPMCOUNTER14:
				case THEAD_C9XX_CSR_SHPMCOUNTER15:
				case THEAD_C9XX_CSR_SHPMCOUNTER16:
				case THEAD_C9XX_CSR_SHPMCOUNTER17:
				case THEAD_C9XX_CSR_SHPMCOUNTER18:
				case THEAD_C9XX_CSR_SHPMCOUNTER19:
				case THEAD_C9XX_CSR_SHPMCOUNTER20:
				case THEAD_C9XX_CSR_SHPMCOUNTER21:
				case THEAD_C9XX_CSR_SHPMCOUNTER22:
				case THEAD_C9XX_CSR_SHPMCOUNTER23:
				case THEAD_C9XX_CSR_SHPMCOUNTER24:
				case THEAD_C9XX_CSR_SHPMCOUNTER25:
				case THEAD_C9XX_CSR_SHPMCOUNTER26:
				case THEAD_C9XX_CSR_SHPMCOUNTER27:
				case THEAD_C9XX_CSR_SHPMCOUNTER28:
				case THEAD_C9XX_CSR_SHPMCOUNTER29:
				case THEAD_C9XX_CSR_SHPMCOUNTER30:
				case THEAD_C9XX_CSR_SHPMCOUNTER31:
				case THEAD_C9XX_CSR_FXCR:
				case THEAD_C9XX_CSR_SMIR:
				case THEAD_C9XX_CSR_SMEL:
				case THEAD_C9XX_CSR_SMEH:
				case THEAD_C9XX_CSR_SMCIR:
				case THEAD_C9XX_CSR_MEBR:
				case THEAD_C9XX_CSR_NT_MSTATUS:
				case THEAD_C9XX_CSR_NT_MIE:
				case THEAD_C9XX_CSR_NT_MTVEC:
				case THEAD_C9XX_CSR_NT_MTVT:
				case THEAD_C9XX_CSR_NT_MEPC:
				case THEAD_C9XX_CSR_NT_MCAUSE:
				case THEAD_C9XX_CSR_NT_MIP:
				case THEAD_C9XX_CSR_NT_MINTSTATE:
				case THEAD_C9XX_CSR_NT_MXSTATUS:
				case THEAD_C9XX_CSR_NT_MEBR:
				case THEAD_C9XX_CSR_NT_MSP:
				case THEAD_C9XX_CSR_T_USP:
				case THEAD_C9XX_CSR_T_MDCR:
				case THEAD_C9XX_CSR_T_MPCR:
				case THEAD_C9XX_CSR_PMPTEECFG:
